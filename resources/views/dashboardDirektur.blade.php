        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="/direktur/listKaryawan" class="waves-effect waves-dark"><i class="fa fa-user"></i> Data Karyawan</a>
                    </li>
                </ul>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    @if ($list->status_persetujuan == 0)
                                                        <form method="post" style="display: flex; justify-content: center">
                                                            @csrf
                                                            <a href="{{ url("direktur/terimaReimbursement/".$list->id) }}">
                                                                <i class="material-icons">check</i><br>Terima
                                                            </a>&nbsp;&nbsp;&nbsp;
                                                            <a href="{{ url("direktur/tolakReimbursement/".$list->id) }}">
